...
// Data contoh, nanti ganti dari session/database
$nama_guru = $_SESSION['nama_guru'] ?? 'Nama Guru';
$role = 'Pengajar / Instructor';
$inisial = strtoupper(substr($nama_guru, 0, 2));

$rooms = [
    ['id' => 'RM-8492', 'pw' => 'EXAM2026', 'tms' => 20, 'submit' => 16],
    ['id' => 'RM-3105', 'pw' => 'KODE99',   'tms' => 20, 'submit' => 16],
];
?>
<!DOCTYPE html>
<html lang="id">
                ...
                <div class="flex justify-between items-center bg-[#0d1b3f] border border-[#1e3a6d] rounded-2xl px-7 py-5">
                    ...
                    <div class="flex gap-8 bg-[#142a56] px-6 py-3 rounded-xl">
                        <div class="flex flex-col items-center">
                            <span class="text-[11px] text-[#8fa1c9] uppercase">TMS (Total Siswa)</span>
                            <span class="text-xl font-bold"><?= (int)$room['tms'] ?></span>
                        </div>
                        <div class="flex flex-col items-center">
                            <span class="text-[11px] text-[#8fa1c9] uppercase">Submit</span>
                            <span class="text-xl font-bold text-[#2ecf7a]"><?= (int)$room['submit'] ?></span>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
